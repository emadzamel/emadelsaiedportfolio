...
import { Code, Brain, BarChart3, Eye, MessageSquare, Target } from "lucide-react";
const Skills = () => {
  const skills = [{
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            return <Card key={skill.name} className="bg-card shadow-card hover:shadow-hover transition-all duration-300 group animate-fade-in" style={{
